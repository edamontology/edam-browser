...
![The concept has two parents](paper_resources/phylogenetic_tree_generation_with_details.png)

The user may directly suggest either the modification or creation of terms by clicking on the "add a child" and "edit" icons at the top-right corner of this panel. These lead the user to a form that directly formats suggestions as github issues ready to be submitted by the user (see Fig. 2).
