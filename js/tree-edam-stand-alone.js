...
//        details +=                 '<span class="label label-default bg-edam-'+branch_of_term+'-light border-one-solid fg-edam-'+branch_of_term+' border-edam-'+branch_of_term+'">'+branch_of_term+'</span>';
        ...
        if (caller_b.is_enabled()){
            var id_b = append_row(community,"<a target=\"_blank\" href=\"https://bio.tools\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Bioinformatics Tools and Services Discovery Portal\">bio.tools</a>","<i>loading</i>");
        ...
        if (caller_s.is_enabled()){
            var id_s = append_row(community,"<a target=\"_blank\" href=\"https://biosphere.france-bioinformatique.fr\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"IFB (ELIXIR France) Cloud Services to analyze life science data\">Biosphere</a>","<i>loading</i>");
        ...
        if (caller_w.is_enabled()){
            var id_w = append_row(community,"<a target=\"_blank\" href=\"https://bioweb.pasteur.fr/\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Online catalog of bioinformatics programs and databanks available at the Institut Pasteur\">BioWeb</a>","<i>loading</i>");
        ...
        if (caller_t.is_enabled()){
            var id_t = append_row(community,"<a target=\"_blank\" href=\"https://tess.elixir-europe.org/\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"ELIXIR Training Portal\">TeSS</a>","<i>loading</i>");
